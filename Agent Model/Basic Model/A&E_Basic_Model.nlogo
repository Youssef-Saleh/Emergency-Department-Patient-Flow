...
;; Global Variables
globals[
  dist_patient_fq               ;; Distribution of frequency of creation of lv patients
  dist_treatment_times          ;; Amount of treatment time required for lv patients
  dist_arrival_type             ;; Defines the arrival location/type - ambulance or waiting room
  ...
  severe_size                   ;; Number of resus spaces
...
to setup
  ...
  setup-background
  set dist_patient_fq [0 0 0 0 1 1 1 2 3 3]
  set dist_treatment_times [3 3 3 3 4 4 5 6 8 9]
  set dist_arrival_type [12 12 12 11 11]
...
to make-newpatients
  create-patients one-of dist_patient_fq                  ;; Make n number of patients where n is one of the distribution for this patient severity
  [set pt_severity_initial 2                                  ;; Set variable initial severity to 1
   set pt_severity 2                                          ;; Set variable severity to 1
   set pt_treatment_time one-of dist_treatment_times          ;; Pick one of the treatment times and set this patient's treatment time variable to this value
   set pt_treatment_time_initial pt_treatment_time
   set pt_arrival_type one-of dist_arrival_type               ;; Set an arrival type
...
;; Associate caregivers with patients
...
set death_prob (random 100)
ask patients with [pt_allocated_caregiver = 1] [
    IF death_prob <= 1 [
      ask one-of patients with [pt_allocated_caregiver = 1] [set pt_location 101 set pt_allocated_caregiver 0]
  ]
]
...
ask patients with [pt_treatment_time < 1 AND ((PT_LOCATION = 22))]
      [set pt_location 91
...
"Waiting Room" 1.0 0 -1184463 true "" "plot count patients with [pt_location = 12]"
...
576
Dead Patients
count patients with [pt_location = 101]
17
1
11
