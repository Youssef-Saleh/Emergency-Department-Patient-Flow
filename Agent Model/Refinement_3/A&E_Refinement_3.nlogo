...
to go
  ...
  IF ( (count patients with [pt_location = 11] + count patients with [pt_location = 12]) <= waiting_room_capacity) [
  make-newpatients
  ]
...
to delete-extra-patients
  ...
  if count patients with [pt_location = 12 OR pt_location = 11] > waiting_room_capacity [
...
"" ""
PENS
"Resus" 1.0 0 -3844592 true "" "plot count patients with [pt_location = 23]"
"Majors" 1.0 0 -1184463 true "" "plot count patients with [pt_location = 22]"
"Minors" 1.0 0 -11033397 true "" "plot count patients with [pt_location = 21]"
